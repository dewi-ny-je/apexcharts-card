...
sed -i -e "s|https://github.com/\([^/]*\)/apexcharts-card/releases/download/.*/apexcharts-card.js|https://github.com/\1/apexcharts-card/releases/download/v${VERSION}/apexcharts-card.js|g" ./README.md
